      ...
      {timeSlots.length === 0 && (
        <Card>
          <CardContent className="text-center py-8">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No time slots configured</h3>
            <p className="text-gray-500">Add your first time slot to start accepting bookings</p>
          </CardContent>
        </Card>
      )}
    </div>
